  ...
  <div className="flex flex-col gap-5">
   <section className="rounded-3xl border border-amber-200 bg-amber-50 p-4 text-amber-900 shadow-sm sm:p-6">
    ...
    <p className="mt-2 text-sm font-semibold leading-relaxed">
     App đã chuyển phần dữ liệu sang snapshot local ở chế độ chỉ đọc. Thao tác ghi sẽ không được thực hiện cho tới khi backend hoạt động lại.
    </p>
